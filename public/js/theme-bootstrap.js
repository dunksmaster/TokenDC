/* Generated from src/js — edit theme.js / theme-bootstrap.js, then npm run build */
(() => {
  // src/js/theme.js
  var STORAGE_KEY = "duacrypto-theme";
  ...
  function injectThemeToggle() {
    ...
    button.innerHTML = '<i data-theme-icon class="fas fa-moon" aria-hidden="true"></i>';
