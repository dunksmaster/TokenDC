 ...
 * If adding CORS later: use hono/cors with an explicit allowlist of origins.
 * Never combine credentials: true with a wildcard origin (CVE-2026-54290; fixed in hono >= 4.12.25).
 */
