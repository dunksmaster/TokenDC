...
export function globalSecurityHeadersBlock() {
  ...
  const cspValue = [
    "default-src 'self';",
    "script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://code.jquery.com https://cdn.jsdelivr.net;",
...
export function staticCacheHeadersBlocks() {
  ...
  return ["/img/*", "/css/*", "/js/*", "/lib/*", "/webp/*", "/fonts/*", "/vendor/*"]
    .map((path) => `${path}\n${cache}`)
    .join("\n\n");
}
